 ...
 */
final class Version20250930062659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_numero_journal_exercice ON ecriture_comptable (journal_id, numero_ecriture, exercice_comptable_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX unique_numero_journal_exercice');

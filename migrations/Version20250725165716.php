 ...
 */
final class Version20250725165716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse DROP CONSTRAINT fk_adresse_client');
        $this->addSql('DROP INDEX idx_c35f081619eb6921');
        $this->addSql('ALTER TABLE adresse ADD nom VARCHAR(100) DEFAULT \'Adresse principale\'');
        $this->addSql('UPDATE adresse SET nom = \'Adresse principale\' WHERE nom IS NULL');
        $this->addSql('ALTER TABLE adresse ALTER COLUMN nom SET NOT NULL');
        $this->addSql('ALTER TABLE adresse DROP type_adresse');
        $this->addSql('ALTER TABLE adresse DROP nom_lieu');
        $this->addSql('ALTER TABLE adresse DROP is_defaut');
        $this->addSql('ALTER TABLE adresse DROP is_facturation_default');
        $this->addSql('ALTER TABLE adresse DROP is_livraison_default');

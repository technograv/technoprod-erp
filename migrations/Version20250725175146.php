 ...
 */
final class Version20250725175146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse ALTER nom DROP DEFAULT');
        $this->addSql('ALTER TABLE adresse ALTER nom SET NOT NULL');
        $this->addSql('ALTER INDEX idx_c35f081619eb6921 RENAME TO IDX_C35F0816E7A1254A');
        ...
        $this->addSql('ALTER TABLE contact ALTER nom DROP NOT NULL');
        $this->addSql('ALTER TABLE contact ALTER prenom DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse ALTER nom SET DEFAULT \'Adresse principale\'');
        $this->addSql('ALTER TABLE adresse ALTER nom DROP NOT NULL');
        $this->addSql('ALTER INDEX idx_c35f0816e7a1254a RENAME TO idx_c35f081619eb6921');
        ...
        $this->addSql('ALTER TABLE contact ALTER nom SET NOT NULL');
        $this->addSql('ALTER TABLE contact ALTER prenom SET NOT NULL');

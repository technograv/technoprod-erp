...
use App\Repository\ContactFacturationRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

#[ORM\Entity(repositoryClass: ContactFacturationRepository::class)]
class ContactFacturation
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function copyFrom(ContactFacturation $source): static
    {
        ...
        $this->telephoneMobile = $source->getTelephoneMobile();
        $this->fax = $source->getFax();
